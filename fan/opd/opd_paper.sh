...
export WANDB_PROJECT="${WANDB_PROJECT:-1.7b_base_capybara_sft247_opd_paper}"
export WANDB_NAME="${WANDB_NAME:-2026_4_2_14:32}"

# Paper-style OPD baseline (Table 8) for Qwen:
...
accelerate launch \
  ...
  --output_dir outputs/opd-qwen3_1_7base_capybarasft-from-8b-paper \
  --learning_rate 3e-6 \
